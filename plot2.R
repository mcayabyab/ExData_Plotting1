...
plot(powerconsumption$DateTime, powerconsumption$Global_active_power, type = "l", xlab = NA, ylab = "Global Active Power (kilowatts)")

#saves file in downloads folder as plot2.png
dev.off()