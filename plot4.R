...
#set up a 2 x 2 plot area
par(mfrow = c(2,2), mar = c(3.9, 3.9, 3.9, 3.9))

##### Plot #1
plot(powerconsumption$DateTime, powerconsumption$Global_active_power, type = "l", xlab = NA, ylab = "Global Active Power")
...
#saves file in downloads folder as plot4.png
dev.off()
